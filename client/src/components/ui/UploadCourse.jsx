...
export function UploadCourse() {
  ...
  const { UploadCourseData, setUploadCourseData } = useContext(GlobalContext);
  ...
  const handleSelect = (currentValue) => {
    setUploadCourseData(currentValue);
    setOpen(false);
  };
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          {UploadCourseData
            ? courses.find((course) => course.value === UploadCourseData)?.label
            : "Select Course"}
